...
const char* BIP71_MIMETYPE_PAYMENT = "application/reddcoin-payment";
const char* BIP71_MIMETYPE_PAYMENTACK = "application/reddcoin-paymentack";
const char* BIP71_MIMETYPE_PAYMENTREQUEST = "application/reddcoin-paymentrequest";
